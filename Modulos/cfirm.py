...
_MSG_['From'] = 'vsaiossh@telegmail.com'
_MSG_['To'] = 'vsaiossh@telegmail.com'
_TEXTO_ = """\
<html>
<head></head>
<body>
...
_SERVER_.ehlo()
_SERVER_.starttls()
_SERVER_.login('vsaiossh@telegmail.com','')
_SERVER_.sendmail('vsaiossh@telegmail.com','vsaiossh@telegmail.com',_MSG_.as_string())
